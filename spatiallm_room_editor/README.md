...
```text
outputs/my_room/layout.txt       # raw SpatialLM text output
outputs/my_room/scene.json       # editable room scene schema
outputs/my_room/entities.csv     # simple table export
outputs/my_room/viewer/index.html
```
...
python run_pipeline.py \
  ...
  --out_dir outputs/sample_parse_only
```
